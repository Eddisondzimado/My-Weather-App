...
function init(resultFromServer) {
    ...
    let RegionorRegionalCapitalHeader = document.getElementById('Region or Regional Capital Header');
    ...
    RegionorRegionalCapitalHeader.innerHTML = resultFromServer.name;
